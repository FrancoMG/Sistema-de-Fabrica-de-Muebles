    ...
    Private Sub btnAgregarCliente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarCliente.Click
        ...
        Else
            ...
            Else
                ...
                sql = ("select count(*) from cliente where idpersona = (select idpersona from persona where idpersona = '" & txtID.Text & "')")
                ...
                If rs(0) > 0 Then
                    ...
                    MsgBox("La persona ya es un cliente")
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            ...
                            sql = ("insert into cliente values('', " & codpersona & ", 1)")
